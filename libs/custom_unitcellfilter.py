...
class StrainFilter(Filter):
    ...
    def __init__(self, atoms,isotropic_pressure=None, mask=None):
        ...
        if isotropic_pressure is None or isotropic_pressure == 0.:
            ...
            self.external_pressure = np.array([isotropic_pressure,]*3+[0]*3)
